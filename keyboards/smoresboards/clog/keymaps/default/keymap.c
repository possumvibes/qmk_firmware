...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_Q, SFT_T(KC_A), ALT_T(KC_S), CTL_T(KC_D), GUI_T(KC_F), KC_G,               KC_H, GUI_T(KC_J), CTL_T(KC_K), ALT_T(KC_L), SFT_T(KC_SCLN), KC_P,
          KC_Z,        KC_X,        KC_C,        KC_V,        KC_B,               KC_N, KC_M,        KC_COMM,     KC_DOT,      KC_SLSH,
                                                 LT(2,KC_TAB),KC_ENT,             KC_SPC,LT(1,KC_BSPC)
    ),
    [1] = LAYOUT(
                     KC_1,    KC_2,    KC_3,    KC_VOLU,           KC_HOME, KC_PGDN, KC_PGUP, KC_END,
    _______,_______, KC_4,    KC_5,    KC_6,    KC_VOLD,           KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_QUOT,KC_DQUO,
    ...
    _______,_______, KC_F4,   KC_F5,   KC_F6,   KC_F11,      KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_INS,RESET,
