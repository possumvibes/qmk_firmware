...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    ,[_APTHD] = LAYOUT_possum_wrapper(
        ________________APTMOD_L1__________________, ________________APTMOD_R1__________________,
        ________________APTMOD_L2__________________, ________________APTMOD_R2__________________,
        ________________APTMOD_L3__________________, ________________APTMOD_R3__________________,
                                   _APTMOD_THUMB_L_, _APTMOD_THUMB_R_
    )
