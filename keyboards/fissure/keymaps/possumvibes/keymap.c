...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    ,[_SEMIMAK] = LAYOUT_alpha_wrapper(
        _________________CANARY_L1_________________, _________________CANARY_R1_________________,
        _________________CANARY_L2_________________, _________________CANARY_R2_________________,
        _________________CANARY_L3_________________, _________________CANARY_R3_________________
    )
