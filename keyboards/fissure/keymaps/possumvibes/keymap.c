...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    ,[_COMBOREF] = LAYOUT_wrapper(
        KC_ESC,  ________________COMBOREF_L1________________, ________________COMBOREF_R1________________, KC_DEL,
        KC_CAPS, ________________COMBOREF_L2________________, ________________COMBOREF_R2________________, KC_QUOT,
    ...
    ,[_SEMIMAK] = LAYOUT_alpha_wrapper(
        _________________SEMIMAK_L1________________, _________________SEMIMAK_R1________________,
        _________________SEMIMAK_L2________________, _________________SEMIMAK_R2________________,
        _________________SEMIMAK_L3________________, _________________SEMIMAK_R3________________
    )
