...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    ,[_APTHD] = LAYOUT_possum_wrapper(
        ________________APTv3_HD_L1________________, ________________APTv3_HD_R1________________,
        ________________APTv3_HD_L2________________, ________________APTv3_HD_R2________________,
        ________________APTv3_HD_L3________________, ________________APTv3_HD_R3________________
    )
    ...
    ,[_MACRO] = LAYOUT_possum_thumbs_wrapper(
    ...
    ,[_NUM] = LAYOUT_possum_thumbs_wrapper(
    ...
    ,[_SYM] = LAYOUT_possum_thumbs_wrapper(
